...
.config(function($stateProvider) {
    $stateProvider
        .state('countries', {
            url: '/country',
            templateUrl: 'dashboard/countries.html',
            controller: 'CountriesCtrl'
        })
        .state('newcountry', {
            url: '/country/new',
            templateUrl: 'dashboard/country.html',
        ...
        .state('countriesgroups', {
            url: '/contriesgroup',
            templateUrl: 'dashboard/countriesgroups.html',
            controller: 'CountriesGroupsCtrl'
        })
        .state('newcountriesgroup', {
            url: '/countriesgroup/new',
            templateUrl: 'dashboard/countriesgroup.html',
