...
class OrderProductSchema(Schema):
    ...
    gross_price = fields.Decimal()
    net_price = fields.Decimal()
    line_gross_price = fields.Decimal()
    line_net_price = fields.Decimal()
...
class OrderSchema(Schema):
    ...
    * tracking_number
    ...
    gross_subtotal = fields.Decimal(dump_only=True)
    net_subtotal = fields.Decimal(dump_only=True)
    carrier_description = fields.String(dump_only=True)
    gross_shipping = fields.Decimal(dump_only=True)
    net_shipping = fields.Decimal(dump_only=True)
    gross_total = fields.Decimal(dump_only=True)
    net_total = fields.Decimal(dump_only=True)
...
rest.add_resource(ApiAllOrders, '/order/all')
rest.add_resource(ApiOrders, '/order')
